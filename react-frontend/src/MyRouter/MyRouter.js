...
import SingleIntentsPage from "../components/IntentsPage/SingleIntentsPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/intents" component={IntentsPage} exact />
                    <Route path="/intents/:singleIntentsId" component={SingleIntentsPage} exact />
                    {/* ~cb-add-route~ */}
